...
with open("../test/test_cases.txt", "r") as test_cases_file:
    ...
    threads = []
    for viewpoint in ["diagonal", "sideon", "bowler", "top-down", "umpire", "batter", "wicket-keeper"]:  # edit this list accordingly - to run easily and to produce the desired simulations
